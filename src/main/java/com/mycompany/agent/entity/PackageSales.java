...
@NamedQueries({
    ...
    @NamedQuery(name = "PackageSales.findByPackageSalescol", query = "SELECT p FROM PackageSales p WHERE p.packageSalescol = :packageSalescol")})
public class PackageSales implements Serializable {
    ...
    @Column(name = "package_salescol")
    private String packageSalescol;
    ...
    public String getPackageSalescol() {
        return packageSalescol;
    }

    public void setPackageSalescol(String packageSalescol) {
        this.packageSalescol = packageSalescol;
    }
