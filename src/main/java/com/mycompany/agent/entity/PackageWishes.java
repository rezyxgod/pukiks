...
public class PackageWishes implements Serializable {
    ...
    @JoinColumn(name = "packagesale_id", referencedColumnName = "package_sale_id")
    @ManyToOne
    private PackageSales packagesaleId;
    ...
    public PackageSales getPackagesaleId() {
        return packagesaleId;
    }

    public void setPackagesaleId(PackageSales packagesaleId) {
