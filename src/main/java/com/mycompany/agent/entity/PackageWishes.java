...
@NamedQueries({
    ...
    @NamedQuery(name = "PackageWishes.findByWishDescriprion", query = "SELECT p FROM PackageWishes p WHERE p.wishDescriprion = :wishDescriprion")})
public class PackageWishes implements Serializable {
    ...
    @Column(name = "wish_descriprion")
    private String wishDescriprion;
    ...
    public String getWishDescriprion() {
        return wishDescriprion;
    }

    public void setWishDescriprion(String wishDescriprion) {
        this.wishDescriprion = wishDescriprion;
    }
